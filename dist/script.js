...
/* harmony import */ var _modules_filterCards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/filterCards */ "./src/js/modules/filterCards.js");
/* harmony import */ var _modules_filterTemp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/filterTemp */ "./src/js/modules/filterTemp.js");
/* harmony import */ var _modules_headerScroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/headerScroll */ "./src/js/modules/headerScroll.js");
...
window.addEventListener('DOMContentLoaded', () => {
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])('.questions__accordion .accordion-header', 'questions-accordion__active');
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])('.aside-menu .accordion-header', 'aside-menu__active', false);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_2__["default"])('[name="phone"]');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_headerScroll__WEBPACK_IMPORTED_MODULE_6__["default"])('.header__top', 'header__scroll');
  Object(_modules_filterCards__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_filterTemp__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
...
const filterCards = () => {
  ...
  function getProducts(markSelector) {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResourse"])('http://localhost:3000/products').then(res => createProducts(res, markSelector)).catch().finally();
  }

  function createProducts(response, markSelector) {
    // Создает масив с номерами карточек, которые отвечают заданому класу
    const empty = [];
  ...
  function createButton() {
    // Динамически создает каждый раз кнопку и помещает ее в div center
  ...
  const loadMore = array => {
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResourse"])('http://localhost:3000/products').then(res => displayProduct(listNumbers, itemsWrapper, amountDisplay, currentIndex, res)).catch().finally();
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/requests */ "./src/js/services/requests.js");
/* harmony import */ var _pagination__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pagination */ "./src/js/modules/pagination.js");



const filterPosts1 = () => {
  function getProducts(markSelector) {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResourse"])('http://localhost:3000/posts').then(res => createPosts(res, markSelector)).catch().finally();
  }
  ...
  function createPosts(response, markSelector) {
    ...
    console.log(empty);
    Object(_pagination__WEBPACK_IMPORTED_MODULE_1__["default"])(empty);
  } // createPosts
...
/* harmony default export */ __webpack_exports__["default"] = (filterPosts1);
...
const pagination = array => {
  ...
  let currentPage = 1;
  let rows = 3;
  Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResourse"])('http://localhost:3000/posts').then(res => displayList(postItems, listElement, rows, currentPage, res)).catch().finally();

  function displayList(items, wrapper, rowsPerPage, page, res) {
    wrapper.innerHTML = '';
    page--;
    let start = rowsPerPage * page;
    let end = start + rowsPerPage; // Создаю массив из номеров карточек, которые должны отображаться на одной странице

    let paginatedItemsArray = items.slice(start, end);
    console.log(paginatedItemsArray); // Перебираю номера и создаю карточки, которые совпадают с номерами
  ...
  function paginationButton(page, items) {
    ...
    button.innerText = page; // Перемещение класа акивности
    ...
    button.addEventListener('click', () => {
      currentPage = page;
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResourse"])('http://localhost:3000/posts').then(res => displayList(items, listElement, rows, currentPage, res)).catch().finally();
    });
    return button;
